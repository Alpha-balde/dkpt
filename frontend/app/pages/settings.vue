        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 mt-1">
              Montants annuels et configuration
            </p>
          </div>
        </div>
        <UButton
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-gray-900 mt-1">
              {{ defaultAmount.toLocaleString('fr-FR') }} GNF
            </p>
            <p class="text-xs text-gray-400 mt-1">
              Appliqué quand aucun montant spécifique n'est défini
            </p>
          </div>
        ...
        <div class="flex items-start gap-3">
          ...
          <div>
            ...
            <ul class="text-sm text-blue-800 mt-2 space-y-1 list-disc list-inside">
              ...
              <li>
                Consultez le suivi des cotisations dans la page <NuxtLink
                  to="/cotisations"
                  class="underline font-medium"
                >Cotisations</NuxtLink>
              </li>
            </ul>
          </div>
        </div>
