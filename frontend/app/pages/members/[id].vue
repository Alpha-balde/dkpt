        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1">
              {{ totalExpected.toLocaleString('fr-FR') }} GNF
            </p>
            <p class="text-xs text-gray-400 mt-1">
              {{ yearData.length }} années
            </p>
          </div>
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p
              ...
              :class="totalGap > 0 ? 'text-red-600' : 'text-green-600'"
            >
              {{ totalGap.toLocaleString('fr-FR') }} GNF
            </p>
            <p class="text-xs text-gray-400 mt-1">
              {{ arrearsYears.length }} année(s) en retard
            </p>
          </div>
          <div
            class="p-3 rounded-full"
            :class="totalGap > 0 ? 'bg-red-50' : 'bg-green-50'"
          >
            <UIcon
              name="i-lucide-alert-circle"
              class="w-6 h-6"
              :class="totalGap > 0 ? 'text-red-500' : 'text-green-500'"
            />
          </div>
        </div>
      </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div v-if="activeTab === 'payments'">
        ...
        >
          <UIcon
            name="i-lucide-credit-card"
            class="w-12 h-12 text-gray-200 mx-auto"
          />
        ...
        >
          ...
          <tbody class="divide-y divide-gray-100">
            ...
            >
              ...
              <td class="px-4 py-3 text-gray-600">
                {{ y.expected.toLocaleString('fr-FR') }} GNF
              </td>
              <td class="px-4 py-3 font-medium text-green-600">
                {{ y.paid.toLocaleString('fr-FR') }} GNF
              </td>
              <td class="px-4 py-3">
      ...
      <div v-if="activeTab === 'arrieres'">
        ...
        >
          ...
          <p class="text-sm text-gray-500 mt-1">
            Ce membre est à jour sur toutes ses cotisations 🎉
          </p>
        </div>
      </div>
    </div>
